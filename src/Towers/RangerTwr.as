package Towers 
{
	 ...
	 * @author i am
	 */
	public class RangerTwr extends Tower
	{
		public static const NAME:String = "RangerTwr";
		private var bulletType:int = Bullet.SMALL_STONE;
		
		public function RangerTwr() 
		{
			...
			_baseDamageMin = 14;
			_baseDamageMax = 22;
			_baseGoldCost = TowerData.baseGoldCostsArray[7];
			_baseWheatCost = TowerData.baseWhealCostsArray[7];
			_baseHealth = 100;
			type = NAME;
			...
			towerMovie = new Skingman_movie_full();
			towerMovie.stop();
			...
			_descriptionText = "Long preparation was needed for an effective use of sling; catapults changed it being a faster in mastering weapon. Shots became more frequent, more exact and strong";
